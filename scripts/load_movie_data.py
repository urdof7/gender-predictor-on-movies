...
Description:
This script loads movie data into a SQLite database defined by the `movie_schema.sql` schema. 
It downloads and processes datasets from various sources, including the original dataset from GitHub 
and Kaggle, and inserts data into the database. The script handles movies, genres, cast members, 
directors, production companies, ratings, and more while ensuring data integrity and consistency.
