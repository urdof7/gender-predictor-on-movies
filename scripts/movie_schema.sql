...
Description:
This schema defines the database structure for a movie dataset. It includes tables for movies, cast members, genres, directors, production companies, languages, countries, and user ratings. The schema is designed to ensure data integrity through relationships and constraints. Views and indexes are included to optimize query performance and provide high-level summaries.

Acknowledgments:
This schema was developed by Brayden Miller with assistance from ChatGPT.
*/
